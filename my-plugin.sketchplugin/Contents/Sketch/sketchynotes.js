...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/sketchynotes.js");
/******/ })
/************************************************************************/
/******/ ({
...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  ...
  webContents.on('copyMessage', function () {
    UI.message('Copy to clipboard!');
  }); // add a handler for a call from web content's javascript

  webContents.on('loadNotes', function (s) {
    ...
    webContents.on('navigatePosts', function (artboardIndex, noteIndex) {
      ...
      document.centerOnLayer(layersList[artboardIndex][noteIndex]); //document.centerOnLayer(document.selectedPage.layers[artboardIndex].layers[noteIndex+1]);
    });
    webContents.on('removePost', function (artboardIndex, noteIndex) {
      ...
      webContents.executeJavaScript('removeNoteView()'); //layersList[artboardIndex].splice(noteIndex, 1);
    });
    webContents.on('toggleView', function (s) {
